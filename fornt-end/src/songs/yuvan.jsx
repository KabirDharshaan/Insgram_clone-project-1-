...
const songList = [
  { name: "Kadhal Aasai - Anjaan", src: song1, image: "https://i1.wp.com/www.chennaikaaran.com/wp-content/uploads/2016/08/yuvan.jpg?fit=1024%2C768&ssl=1" },
  { name: "Adada Mazhaida - Paiya", src: song2, image: "https://i.scdn.co/image/ab67616d0000b2737de8959929372430846f570e" },
  { name: "En Kadhal Solla - Paiya", src: song3, image: "https://i.ytimg.com/vi/61U0e-i4jSw/maxresdefault.jpg" },
  { name: "Thuli Thuli - Paiya", src: song4, image: "https://tamillyrics143.com/wp-content/uploads/2019/02/Thuli-Thuli-Mazhaiyaai-Song-Lyrics.jpg" },
  { name: "Yetho Ondru Ennai- Paiya", src: song5, image: "https://i.ytimg.com/vi/g1nl1x9ryNE/maxresdefault.jpg?sqp=-oaymwEmCIAKENAF8quKqQMa8AEB-AG-B4AC0AWKAgwIABABGD0gVihlMA8=&rs=AOn4CLBrkIS9lVGCjt-rQH548RZFk1dHrw" },
  { name: "Oru Naalaikkul- Yaaradi Nee Mohini", src: song6, image: "https://tse3.mm.bing.net/th?id=OIP.cr5eBF9ZXRs6RFqdBvkFKgHaEK&pid=Api&P=0&h=180" },
  { name: "Ithuvarai - Goa", src: song7, image: "https://c.saavncdn.com/260/Goa-Tamil-2010-20210522185821-500x500.jpg" },
  { name: "En Fuse Pochu - Arrambam", src: song8, image: "https://i.pinimg.com/originals/50/e7/b0/50e7b099c18f84a5e505e872f22e02ac.jpg" },
  { name: "Klesa Kadhala - Dada", src: song9, image: "https://static.toiimg.com/photo/98079942.cms" },
  { name: "Ennai Vittu  - Love Today", src: song10, image: "https://tse3.mm.bing.net/th?id=OIP.VFxWA98wgrfzNMpS7l8qWwHaEK&pid=Api&P=0&h=180" },
  { name: "Anbae peranbae - NGK", src: song11, image: "https://tse4.mm.bing.net/th?id=OIP.cnoJoPKiRLh__ircqBVXWgHaEK&pid=Api&P=0&h=180" },
  { name: "Oru Kal Oru Kannadi - Siva Manasula Sakthi", src: song12, image: "https://i.ytimg.com/vi/oPyi9Ci78tQ/maxresdefault.jpg" },
  { name: "Pogathey - Dada", src: song13, image: "https://tse3.mm.bing.net/th?id=OIP.-LxWEuoALswDi3eRkrywjwHaEK&pid=Api&P=0&h=180" }
];
      ...
      <div className="w-1/4 bg-[#121E2D] text-white p-6 rounded-l-xl">
        ...
        <ul className="space-y-4">
          {songList.map((song, index) => (
            <li key={index} className="cursor-pointer hover:text-green-400" onClick={() => handleSelectSong(index)}>
              {song.name}
            </li>
          ))}
        </ul>
        ...
        <div className="w-full flex flex-col items-center bg-white p-8 rounded-xl shadow-xl">
          ...
          <div className="flex items-center gap-8 mt-4">
            ...
            <button
              ...
              className="text-2xl bg-white text-gray-700 px-6 py-2 rounded-full hover:bg-gray-200"
            >
